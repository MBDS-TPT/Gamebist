export const CategoryIcons = {
    "Basketball": (
        <>
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width="30px" viewBox="0 0 512 512" xmlSpace="preserve">
            <g>
                <g>
    ...
    "All sports": (
        <>
            <svg height="30px" viewBox="0 0 24 24" width="30px" xmlns="http://www.w3.org/2000/svg"><path d="m21.5 0h-19c-1.378 0-2.5 1.121-2.5 2.5v19c0 1.379 1.122 2.5 2.5 2.5h19c1.378 0 2.5-1.121 2.5-2.5v-19c0-1.379-1.122-2.5-2.5-2.5zm.5 2.5v8.5h-9v-9h8.5c.276 0 .5.225.5.5zm-19.5-.5h8.5v9h-9v-8.5c0-.275.224-.5.5-.5zm-.5 19.5v-8.5h9v9h-8.5c-.276 0-.5-.225-.5-.5zm19.5.5h-8.5v-9h9v8.5c0 .275-.224.5-.5.5z"/></svg>    
        </>
    ),
    "Football": (
        <>
            <svg version="1.1" id="foot" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width="30px" height="30px" viewBox="0 0 952.1 952.1" xmlSpace="preserve"
                >
            <g>
                <g>
